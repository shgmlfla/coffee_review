...
if (document.category_name.includes("음식점 > 카페")) {
  ...
  resultHtml += "<form action='register' method='GET' id='review-form'>";
  ...
  resultHtml += "<button type='submit' class='btn btn-danger' data-toggle='tooltip' title='' data-original-title='Edit' style='font-size: clamp(15px, 2vw, 20px); border: 1.3px solid #774c2a; color: #56361d;'>장소 선택</button>";
  resultHtml += "</form>";
  resultHtml += "<td class='candidate-list-favourite-time text-center'>"
  resultHtml += "</td>";
}
